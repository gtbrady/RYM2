...
public class PhoneAppointment extends nAppointment{
    ...
    public PhoneAppointment(int appointmentID, int counselorID, int clientID, AppointmentType type,
                            String description, String startTime, String endTime, String coPhone, String clPhone) {
